  ...
  return (
    <div className="w-full absolute bottom-20 px-6">
      <div className="flex justify-center items-center gap-x-2">
        <Button className="bg-[#CE3245] text-white w-full text-xs sm:text-lg md:w-1/3 py-2 sm:py-2.5">
          I need help
          <div>
            <Image src={flag} width={22} height={22} alt="img" />
          </div>
        </Button>
        <Button className="bg-[#1c4ba9] text-white w-full text-xs sm:text-lg md:w-1/3 py-2 sm:py-2.5">
          I want to help 🍱
        </Button>
      </div>
