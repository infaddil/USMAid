...
const RightSideDrawer = ({ isSearch, setIsSearch, details, setDetails, setLoginModal, openDrawer,setOpenDrawer }) => {
  return (
    ...
    <div className={`${openDrawer ? `${styles.openSlideAnimation}`: styles.closeSlideAnimation } absolute right-0 top-0 py-4 w-full dark:bg-[#292929]  md:w-1/3 lg:w-1/4 h-screen overflow-x-scroll`}>
      <div>
